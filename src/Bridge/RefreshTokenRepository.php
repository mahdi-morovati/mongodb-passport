...
use MahdiMorovati\MongoDbPassport\Events\RefreshTokenCreated;
use MahdiMorovati\MongoDbPassport\RefreshTokenRepository as PassportRefreshTokenRepository;
