...
use MahdiMorovati\MongoDbPassport\Bridge\User;
use MahdiMorovati\MongoDbPassport\Exceptions\InvalidAuthTokenException;
...
trait RetrievesAuthRequestFromSession
{
     ...
     * @return void
     *
     * @throws \MahdiMorovati\MongoDbPassport\Exceptions\InvalidAuthTokenException
     */
