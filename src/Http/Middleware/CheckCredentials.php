...
abstract class CheckCredentials
{
     ...
     * @param  \MahdiMorovati\MongoDbPassport\TokenRepository  $repository
     * @return void
     */
     ...
     * @return void
     *
     * @throws \MahdiMorovati\MongoDbPassport\Exceptions\MissingScopeException|\Illuminate\Auth\AuthenticationException
     */
